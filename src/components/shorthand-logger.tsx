...
export function ShorthandLogger() {
  ...
  return (
    <div className="w-full space-y-4 font-sans text-zinc-100 pb-16">
      ...
      {/* Movement Animation & Visual Guide Modal */}
      <ExerciseGuideModal
        guide={selectedGuide}
        isOpen={isGuideOpen}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-7 space-y-4">
            ...
            <section className="p-4 rounded-2xl bg-zinc-900/90 border border-zinc-800 shadow-xl">
              ...
              {todaysWorkout.isRestDay ? (
                ...
                <>
                  ...
                  {/* Exercises List with Movement Visuals */}
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <button
                              ...
                              className="relative w-11 h-11 rounded-lg overflow-hidden border border-zinc-800 hover:border-emerald-500/60 bg-black shrink-0 transition group cursor-pointer"
                              title={`View animation & cues for ${guide.name}`}
                            >
                              ...
                              <div className="absolute inset-0 bg-black/30 group-hover:bg-transparent transition flex items-center justify-center">
                                <Info className="w-3.5 h-3.5 text-white/80 opacity-0 group-hover:opacity-100 transition" />
                              </div>
                            </button>
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] text-emerald-400/90 bg-emerald-950/60 border border-emerald-900/60 px-1.5 py-0.2 rounded font-mono">
                                  {guide.targetMuscle.split(" ")[0]}
                                </span>
                              </div>
                          ...
                          <div className="flex items-center gap-1.5">
                            <button
                              ...
                              className="px-2 py-1.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-zinc-200 border border-zinc-800 text-[11px] font-bold flex items-center gap-1 transition cursor-pointer"
                              title="Form guide & cues"
                            >
          ...
          {(() => {
            const activeGuide = getExerciseGuide(activeExercise);
            return (
              <section className="p-4 rounded-2xl bg-zinc-900/90 border border-zinc-800 shadow-xl">
                <div className="flex items-center justify-between text-xs text-zinc-400 font-mono">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setSelectedGuide(activeGuide);
                        setIsGuideOpen(true);
                      }}
                      className="text-[10px] text-zinc-400 hover:text-emerald-300 border border-zinc-800 hover:border-emerald-500/50 px-2 py-0.5 rounded bg-zinc-950 flex items-center gap-1 transition cursor-pointer"
                    >
                      <Info className="w-3 h-3 text-emerald-400" />
                ...
                <div className="mt-2 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3.5">
                    ...
                    <button
                      ...
                      className="relative w-14 h-14 rounded-xl overflow-hidden border border-zinc-800 hover:border-emerald-500/60 bg-black shrink-0 transition cursor-pointer group"
                      title="Click to view full form cues & warnings"
                    >
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src={activeGuide.animationUrl}
                        alt={activeGuide.name}
                        className="w-full h-full object-cover"
                        loading="lazy"
                        onError={(e) => {
                          (e.target as HTMLImageElement).src = activeGuide.thumbnailUrl;
                        }}
                      />
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-[10px] text-emerald-400 font-bold uppercase bg-emerald-950/60 px-1.5 py-0.2 rounded border border-emerald-900/60">
                          {activeGuide.targetMuscle}
                        </span>
                        <span className="text-[10px] text-zinc-500 hidden sm:inline">
                          • {activeGuide.coachingCues[0]?.slice(0, 32)}...
                        </span>
                      </div>
                    </div>
                  </div>
